...
--
-- Host: dbMysql
-- Tempo de geração: 10/06/2022 às 21:31
...
CREATE TABLE `Numeros` (
  ...
  `impares` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `pares` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
